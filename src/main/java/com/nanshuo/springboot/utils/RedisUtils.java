...
public class RedisUtils {
    ...
    /**
     * 向指定的 Redis Hash 结构中批量插入多个字段的数据
     *
     * @param key  钥匙
     * @param maps 地图
     */
     ...
     * @param key     钥匙
     * @param options 选项
     * @return {@code Cursor<Entry<Object, Object>>}
     */
     ...
     * @param start 开始
     * @param end   结束
     * @return {@code Set<TypedTuple<String>>}
     */
     ...
     * @param key     钥匙
     * @param options 选项
     * @return {@code Cursor<TypedTuple<String>>}
     */
