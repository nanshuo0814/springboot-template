...
public class UserController {
    ...
    @Check(checkParam = true)
    public ApiResponse<Boolean> userPasswordReset(HttpServletRequest request, @RequestBody UserPasswordResetRequest userPasswordResetRequest) {
        return ApiResult.success(userService.userPasswordReset(request, userPasswordResetRequest));
    }
    ...
    public ApiResponse<Boolean> updateUserPassword(HttpServletRequest request, @RequestBody UserPasswordUpdateRequest userPasswordUpdateRequest) {
        return ApiResult.success(userService.userPasswordUpdate(request, userPasswordUpdateRequest));
    }
    ...
    public ApiResponse<String> updateUserInfo(@RequestBody UserUpdateInfoRequest userUpdateInfoRequest,
        ...
        return ApiResult.success("更新用户信息成功！");
    }
