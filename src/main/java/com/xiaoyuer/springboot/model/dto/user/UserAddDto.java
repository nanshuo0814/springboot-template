...
public class UserAddDto implements Serializable {
    ...
    @CheckParam(required = NumberConstant.FALSE_VALUE, regex = VerifyRegexEnums.USERNAME, regexErrorMsg = "用户名只能包含字母、数字或汉字")
    ...
    @CheckParam(required = NumberConstant.FALSE_VALUE, minLength = 6, maxLength = 18, lenghtErrorMsg = "密码长度必须在6-18之间", regex = VerifyRegexEnums.PASSWORD, regexErrorMsg = "密码必须包含字母、数字,可以有特殊字符")
    ...
    @CheckParam(required = NumberConstant.FALSE_VALUE,regex = VerifyRegexEnums.USER_GENDER, regexErrorMsg = "性别参数错误,请输入对应的性别,0:女,1:男,2:未知")
    ...
    @CheckParam(required = NumberConstant.FALSE_VALUE, regex = VerifyRegexEnums.USER_ROLE, regexErrorMsg = "用户角色只能是user或admin")
