...
public class CustomAopConfig {
     ...
     */
    @Pointcut("@annotation(com.xiaoyuer.springboot.annotation.CheckAuth)")
     ...
     */
    @Pointcut("execution(* com.xiaoyuer.springboot.controller.*.*(..)) && !@annotation(com.xiaoyuer.springboot.annotation.Check)")
